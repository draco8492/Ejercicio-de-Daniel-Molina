	...
	echo ---------------------------------
		...
		6) 	opcion3=0
		   	while [ $opcion3 -ne 6 ]; do
				...
				echo 4. Limpia la cache de paquetes
				echo 5. Realiza todas las actualizaciones y limpiezas indicadas anteriormente
				...
				case $opcion3 in
					...
					6) echo volviendo al menu principal;;
